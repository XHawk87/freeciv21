...
---
--- @return int moves The additional move (and work) points granted by the unit's veterancy level.
function Unit:veteran_move_bonus() end

---
--- @return string activity The activity that the unit is currently performing.
function Unit:activity_name() end

---
--- @return string extra The extra that is currently under construction, or nil.
function Unit:activity_target_name() end
