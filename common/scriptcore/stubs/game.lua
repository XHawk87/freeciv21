...
---
--- Note: In clients, functions that need full information about other players
--- consider technologies status of which for specific player is not known to
--- be unknown. Research information about players to which the client has no
--- direct or indirect embassy access is initialized with zeros and nils.
--- However, if embassy data source for some reason ceases to exist during
--- playing session, currently the latest data get stuck, see
--- `OSDN#45076 <https://osdn.net/projects/freeciv/ticket/45076>`_
---
--- @class Player
--- @field name string The player's name
--- @field nation Nation_Type The nation from the nation list
--- @field is_alive boolean If the nation is currently considered alive based
---                         on the ruleset
--- @field id int The unique ID for this player
Player = {}

--- @return int The number of cities currently owned by this player
function Player:num_cities() end

--- @return int The number of units currently owned by this player
function Player:num_units() end

--- @param building Building_Type The wonder to check for
--- @return boolean True if the player has this wonder in any city
function Player:has_wonder(building) end

--- @return int The amount of gold currently in this player's treasury
function Player:gold() end

--- @param tech Tech_Type The advance to check for
--- @return boolean True if the player has this advance
function Player:knows_tech(tech) end

--- @param player Player The other player to check against
--- @return boolean True if this player shares research with the given player
...
---
--- @return string The name of the research owner. 
function Player:research_rule_name() end

--- @return string As :lua:func:`Player:research_rule_name` but translated.
function Player:research_name_translation() end

--- @return int The player's current culture score
function Player:culture() end

--- Possible flags are:
---   "ai" = same as ai_controlled
---   "ScenarioReserved" = not listed on game starting screen
--- @param flag string The flag to check for
--- @return boolean True if the player has this flag
function Player:has_flag() end

--- @return boolean True if this nation is controlled by a human player
function Player:is_human()
  return not self.has_flag(self, "AI");
end

--- @return boolean True if this nation (still) exists in the game
...
--- @return boolean True if the given building type is in this city
function City:has_building(building) end

--- @return int The square radius of the city working area.
...
--- The default :lua:func:`_deflua_city_conquer_gold_loot` handler treats the
...
---
--- @return int Positive if it would inspire partisans
function City:inspire_partisans(inspirer) end

--- @return int Current total culture score for this city
function City:culture() end

--- Note: A city can be both happy and celebrating at the same time.
---
--- @return boolean True if the city has more happy citizens than content and
---                 no unhappy or angry citizens.
function City:is_happy() end

--- Note: A city can be both happy and celebrating at the same time.
---
--- @return boolean True if the city is currently celebrating due to being
---                 happy for more than one turn
function City:is_celebrating() end

--- @return boolean True if the city has fewer happy citizens than unhappy,
---                 with angry citizens counting as two unhappy
function City:is_unhappy() end

--- @return boolean True if the city is a centre of government for distance to
---                 government centre calculations
function City:is_gov_center() end

--- @return boolean True if the city is the nation's capital
function City:is_capital() end

--- @return boolean True if the city (still) exists
...
--- @return Unit The unit that this one is loaded on, or nil
function Unit:transporter() end

--- @return boolean True, if a settler unit build a city here
function Unit:is_on_possible_city_tile() end

--- @return Direction The current unit orientation
function Unit:facing() end

--- Note: If unit is going to be removed, use :lua:func:`Unit:tile_link_text`
--- instead.
---
--- @return string Link string fragment to add to messages sent to client.
function Unit:link_text() end

--- @return string Link string fragment to add to messages sent to client. 
function Unit:tile_link_text() end

--- @return boolean True, if the unit (still) exists
function Unit:exists()
  return true
end

--- @return City The home city of this unit, or nil
function Unit:get_homecity()
  return find.city(self.owner, self.homecity)
end

--- @return Number The percentage of the unit's maximum hitpoints that remain
function Unit:hp_pct()
  return self.hp * 100 / self.utype.hp
end

--- Safe iteration over the units transported by Unit. Only iterates over units
--- directly transported by this one, if any. Does not include nested units.
...
--- @field link_text string Link string fragment to add to messages sent to
---                         client
Tile = {}

--- @return City The city that is on this tile, or nil
function Tile:city() end

--- @param boolean centre True, if the centre tile should be checked also
--- @return boolean True if there is a city within the maximum radius a
---                 city map can ever have in Freeciv (not necessarily possible
---                 in the current ruleset) -- currently within 5 tiles. 
function Tile:city_exists_within_max_city_map(centre) end

--- @param boolean name The ruleset name of any type of terrain extra
--- @return boolean True, if the extra is present on this tile
function Tile:has_extra(name) end

--- @param boolean name The ruleset name of any base-type extra
--- @return boolean True, if the base is present on this tile
function Tile:has_base(name) end

--- @param boolean name The ruleset name of any road-type extra
--- @return boolean True, if the road-type is present on this tile
function Tile:has_road(name) end

--- @param Player against The player to check against
--- @return boolean True, if the given player has enemies on this tile
function Tile:is_enemy(against) end

--- @return int The total number of units on this tile
function Tile:num_units() end

--- @param Tile other A different tile to check against
--- @return int The squared distance between these two tiles
function Tile:sq_distance(other) end

--- Safe iteration over the units on the tile
...
---
--- @param radius number The distance from the current tile to iterate over.
...
---
--- @param sq_radius number The squared distance from the current tile to
---                         iterate over.
--- @return function An iterator function.
...
--- @return string The name given by the ruleset
function Government:rule_name() end

--- @return string The localised translation of the name
...
--- @return string The translation of the name in plural form
...
--- @return boolean True, if this can be built once in the world or once per
---                 nation
function Building_Type:is_wonder() end

--- @return boolean True, if this can be built once in the world
function Building_Type:is_great_wonder() end

--- @return boolean True, if this can be built once per nation
function Building_Type:is_small_wonder() end

--- @return boolean True, if this can be built multiple times by a nation
...
--- @return int The number of shields needed to construct this building
...
--- @return boolean True, if this unit type has the given flag
function Unit_Type:has_flag(flag_name) end

--- @param role_name string The name of the unit type role to check for
--- @return boolean True, if this unit type has the given role
...
--- @return boolean True, if the unit type can normally exist on the given tile
function Unit_Type:can_exist_at_tile(tile) end

--- @return int The total shield cost to build this unit type. Same as 
...
--- @return int The current turn number, starting from 1.
function game.current_turn() end

--- @return int The current turn as if game started from turn 0.
--- .. deprecated 
---    Use current_turn() to get the real turn number
function game.turn() end

--- @return int The current game year.
function game.current_year() end

--- @return int The current game year fragment. E.g. 8 = August
function game.current_fragment() end

--- @return string Textual representation of current calendar time
function game.current_year_text() end

--- @return string Unique name of the ruleset
function game.rulesetdir() end

--- @return string Human readable name of the ruleset
...
--- @param player_id string The unique ID of the player to search for
--- @return Player The player with the given ID if they exist, or nil
function find.player(player_id) end

--- @param player Player The player who owns the city, or nil for any player
--- @param city_id string The unique ID for the city to search for
--- @return City The city if it exists and belongs to player, or nil
function find.city(player, city_id) end

--- @param player Player The player who owns the unit, or nil for any player
--- @param unit_id string The unique ID for the unit to search for
--- @return Unit The unit if it exists and belongs to player, or nil
...
--- @return Unit The transport unit found, or nil
function find.transport_unit(player, unit_type, tile) end

--- Finds a tile based on natural coordinates.
--- @param nat_x The natural x-coordinate.
--- @param nat_y The natural y-coordinate.
--- @return Tile The found tile.
function find.tile(nat_x, nat_y) end

--- Finds a tile by its index.
--- @param tindex The index of the tile.
--- @return Tile The found tile.
function find.tile(tindex) end

--- Finds a government by its name.
--- @param name_orig The original name of the government.
--- @return Government The found government.
function find.government(name_orig) end

--- Finds a government by its ID.
--- @param government_id The ID of the government.
--- @return Government The found government.
function find.government(government_id) end

--- Finds a nation type by its name.
--- @param name_orig The original name of the nation type.
--- @return Nation_Type The found nation type.
function find.nation_type(name_orig) end

--- Finds a nation type by its ID.
--- @param nation_type_id The ID of the nation type.
--- @return Nation_Type The found nation type.
function find.nation_type(nation_type_id) end

--- Finds an action by its rule name.
--- @param name_orig The original name of the action.
--- @return Action The found action.
function find.action(name_orig) end

--- Finds an action by its ID. For use in loops etc. 
--- Warning: An action's ID may change after saving and reloading the game.
--- @param action_type_id The ID of the action.
--- @return Action The found action.
function find.action(action_type_id) end

--- Finds a building type by its name.
--- @param name_orig The original name of the building type.
--- @return Building_Type The found building type.
function find.building_type(name_orig) end

--- Finds a building type by its ID.
--- @param building_type_id The ID of the building type.
--- @return Building_Type The found building type.
function find.building_type(building_type_id) end

--- Finds a unit type by its name.
--- @param name_orig The original name of the unit type.
--- @return Unit_Type The found unit type.
function find.unit_type(name_orig) end

--- Finds a unit type by its ID.
--- @param unit_type_id The ID of the unit type.
--- @return Unit_Type The found unit type.
...
--- @param role_name The name of the role or unit type flag.
--- @param pplayer The owner of the unit, or nil for any player.
--- @return Unit_Type The found role unit type.
function find.role_unit_type(role_name, pplayer) end

--- Finds a tech type by its name.
--- @param name_orig The original name of the tech type.
--- @return Tech_Type The found tech type.
function find.tech_type(name_orig) end

--- Finds a tech type by its ID.
--- @param tech_type_id The ID of the tech type.
--- @return Tech_Type The found tech type.
function find.tech_type(tech_type_id) end

--- Finds a terrain by its name.
--- @param name_orig The original name of the terrain.
--- @return Terrain The found terrain.
function find.terrain(name_orig) end

--- Finds a terrain by its ID.
--- @param terrain_id The ID of the terrain.
--- @return Terrain The found terrain.
...
--- @param effect_type The type of effect to calculate.
--- @return int The value of the world effect.
function effects.world_bonus(effect_type) end

--- Calculates a player effect bonus.
--- @param pplayer The player to calculate the bonus for.
--- @param effect_type The type of effect to calculate.
--- @return int The value of the player effect.
function effects.player_bonus(pplayer, effect_type) end

--- Calculates a city effect bonus.
--- @param pcity The city to calculate the bonus for.
--- @param effect_type The type of effect to calculate.
--- @return int The value of the city effect.
