...
--- Instructs the server to save the game. As with the /save command, if
--- filename is empty, the server chooses an appropriate filename.
---
--- @param String filename The filename to use, or nil to use a default.
function server.save(filename) end

--- @return boolean True, if the game has been started.
...
--- @param String tag The tag of the track to play.
...
--- @return String The value of a server setting as a string. 
function server.setting.get(name) end


--- Send event notifications to players. 
---
--- See the :lua:table:`E` module for a list of possible event types.
---
--- !doctype table
--- @class notify
notify = {}
...
---
--- @param String message A :lua:func:`string.format`-style message.
function notify.all(...)
...
---
--- @param Player player The player to send the event message to, or nil for 
---                      all players.
...
---
--- @param Player player The player to send the event message about.
--- @param boolean selfmsg True, if the player should also receive the event.
--- @param String message A :lua:func:`string.format`-style message.
...
--- @param home_city City The city that the unit will belong to, or nil for
---                       unhomed.
--- @param moves_left int The initial number of moves left for the unit. -1
---                       for max.
...
--- @param transport Unit The transport unit it starts in, or nil for not in a
---                       transport.
--- @return Unit The created unit.
...
--- @param reason string The reason for the damage. See
---                      :ref:`reason <script-unit-loss-reasons>`
--- @param killer Player The player responsible for the damage, or nil.
--- @return bool True if the unit survived.
...
--- @return bool True if the terrain change was successful, false otherwise.
...
--- @return Tech_Type The technology that was given, or nil if they already had
---                   the tech.
...
--- @return bool False if any units on the tile were killed (or would have been
--  killed, if there were no units). 
...
---
--- @param type edit.climate_change_type The type of climate change to apply.
--- @param effect int The magnitude of the effect (approximately the number of
---                   tiles affected.)
function edit.climate_change(type, effect) end
...
---
--- Takes no account of the :ref:`option-civil-war-size` server option (but the
--- player must have at least two cities).
---
...
--- @return Player The new rebel AI player, or nil if it failed.
...
--- @return bool True if the move was successful, false it died.
...
--- is usually :lua:func:`~Player.trait_base` + 
--- :lua:func:`~Player.trait_current_mod`. See :lua:func:`edit.trait_mod` for
--- traits. 
--- @param player Player The AI player whose trait is being queried.
--- @param trait_name string The name of the trait to retrieve.
--- @return int The value of the specified trait.
function Player.trait(player, trait_name) end

--- Gets the base trait value (chosen at game start, before any trait_mod) for
--- a player.
--- @param player Player The AI player whose base trait is being queried.
--- @param trait_name string The name of the trait to retrieve.
--- @return int The base value of the specified trait.
function Player.trait_base(player, trait_name) end

--- Gets the current modifier of a trait for a player.
--- @param player Player The AI player whose trait modifier is being queried.
--- @param trait_name string The name of the trait to retrieve the current
---                          modifier for.
--- @return int The current modification value of the specified trait.
function Player.trait_current_mod(player, trait_name) end

--- Gets the minimum start value of an AI trait for a nation type.
--- @param nation Nation_Type The nation type being queried.
--- @param trait_name string The name of the AI trait.
--- @return int The minimum value of the specified trait.
function Nation_Type.trait_min(nation, trait_name) end

--- Gets the maximum start value of an AI trait for a nation type.
--- @param nation Nation_Type The nation type being queried.
--- @param trait_name string The name of the AI trait.
--- @return int The maximum value of the specified trait.
function Nation_Type.trait_max(nation, trait_name) end

--- Gets the default start value of an AI trait for a nation type. Used when
--- server option :ref:`<server-option-trait-distribution>' is :literal:`FIXED`.
--- @param nation Nation_Type The nation type being queried.
--- @param trait_name string The name of the AI trait.
--- @return int The default value of the specified trait.
function Nation_Type.trait_default(nation, trait_name) end
